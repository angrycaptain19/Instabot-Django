...
class Input(object):
  ...
  def __init__(
    ...
    if concepts and not isinstance(concepts, (list, tuple)):
...
class Workflow(object):
  ...
  def predict_by_url(
    ...
    input_ = Video(url=url) if is_video is True else Image(url=url)
    ...
    return self.predict([input_], output_config)
  ...
  def predict_by_filename(
    ...
    input_ = Video(file_obj=fileio) if is_video is True else Image(file_obj=fileio)
    output_config = ModelOutputConfig(
        language=lang,
        min_value=min_value,
        max_concepts=max_concepts,
  ...
  def predict_by_base64(
    ...
    return self.predict([input_], model_output_config)
  ...
  def predict(self, inputs, output_config=None):
    ...
    return self.api.predict_workflow(self.wf_id, inputs, output_config)
...
class Workflows(object):
  ...
  def get_by_page(self, public_only=False, page=1, per_page=20):
    ...
    res = self.api.get_workflows(public_only)
    return [Workflow(self.api, one) for one in res['workflows']]
  ...
  def get(self, workflow_id):  # type: (str) -> Workflow
    ...
    return Workflow(self.api, res['workflow'])
...
class Models(object):
  ...
  def delete(self, model_id, version_id=None):  # type: (str, typing.Optional[str]) -> dict
    ...
    if not version_id:
      return self.api.delete_model(model_id)
    else:
      return self.api.delete_model_version(model_id, version_id)
  ...
  def bulk_delete(self, model_ids):  # type: (typing.List[str]) -> dict
    ...
    return self.api.delete_models(model_ids)
  ...
  def delete_all(self):  # type: () -> dict
    ...
    return self.api.delete_all_models()
  ...
  def search(self, model_name, model_type=None):
    ...
    if res.get('models'):
      return [self._to_obj(one) for one in res['models']]
    else:
      return None
...
class Inputs(object):
  ...
  def create_image(self, image):  # type: (Image) -> Image
    ...
    return self._to_obj(ret['inputs'][0])
  ...
  def search(self, qb, page=1, per_page=20, raw=False):
    ...
    return [self._to_search_obj(one) for one in res['hits']]
  ...
  def search_by_annotated_concepts(
    ...
    if concept or concepts:
      ...
      if concept_id and not isinstance(concept_id, basestring):
        ...
        raise UserError('concepts must be a list')
      elif concept_ids and not all(
            isinstance(one, basestring) for one in concept_ids):
        raise UserError('concepts must be a list of all string')
  ...
  def send_search_feedback(self, input_id, feedback_info=None):
    ...
    return self.api.send_search_feedback(feedback_input)
  ...
  def bulk_update(self, images, action='merge'):
    ...
    return [self._to_obj(item) for item in ret['inputs']]
  ...
  def delete_concepts(self, input_id, concepts):  # type: (str, typing.List[str]) -> Image
    ...
    return self.update(
        Image(image_id=input_id, concepts=concepts), action='remove')
  ...
  def bulk_merge_concepts(self, input_ids, concept_lists):
    ...
    return self.bulk_update(inputs, action='merge')
  ...
  def bulk_delete_concepts(self, input_ids, concept_lists):
    ...
    return self.bulk_update(inputs, action='remove')
  ...
  def merge_concepts(
    ...
    action = 'overwrite' if overwrite is True else 'merge'
    return self.update(image, action=action)
...
class Concepts(object):
  ...
  def get_by_page(self, page=1, per_page=20):  # type: (int, int) -> typing.List[Concept]
    ...
    res = self.api.get_concepts(page, per_page)
    return [self._to_obj(one) for one in res.get('concepts', [])]
  ...
  def get(self, concept_id):  # type: (str) -> Concept
    ...
    if res.get('concept'):
      return self._to_obj(res['concept'])
    else:
      return None
