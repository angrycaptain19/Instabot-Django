    ...
    def __init__(self, callback):
        ...
        def wrapper(ssl, cdata):
            try:
                ...
                data = _ffi.from_handle(cdata) if cdata != _ffi.NULL else None
                # Call the callback.
...
class Context(object):
    ...
    def load_verify_locations(self, cafile, capath=None):
        ...
        *pemfile* or *capath* may be :data:`None`.
        ...
        :return: None
        """
        cafile = _ffi.NULL if cafile is None else _path_string(cafile)
        capath = _ffi.NULL if capath is None else _path_string(capath)
    ...
    def _set_ocsp_callback(self, helper, data):
        ...
        self._ocsp_data = _ffi.NULL if data is None else _ffi.new_handle(data)
...
class Connection(object):
    ...
    def _raise_ssl_error(self, ssl, result):
        ...
        if error == _lib.SSL_ERROR_WANT_READ:
            ...
            if _lib.ERR_peek_error() == 0:
                if result < 0:
                    errno = _ffi.getwinerror()[0] if platform == "win32" else _ffi.errno
                    if errno != 0:
    ...
    def recv_into(self, buffer, nbytes=None, flags=None):
        ...
        """
        nbytes = len(buffer) if nbytes is None else min(nbytes, len(buffer))
    ...
    def get_protocol_version(self):
        ...
        :rtype: :class:`int`
        """
        return _lib.SSL_version(self._ssl)
