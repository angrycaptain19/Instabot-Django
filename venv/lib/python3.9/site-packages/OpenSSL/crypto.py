...
class _EllipticCurve(object):
    ...
    def _load_elliptic_curves(cls, lib):
        ...
        return {cls.from_nid(lib, c.nid) for c in builtin_curves}
    ...
    def get_serial_number(self):
        ...
        try:
            ...
            try:
                ...
                return int(hexstring_serial, 16)
            finally:
...
class PKCS12(object):
    ...
    def export(self, passphrase=None, iter=2048, maciter=1):
        ...
        pkey = _ffi.NULL if self._pkey is None else self._pkey._pkey
        cert = _ffi.NULL if self._cert is None else self._cert._x509
